...
public class StopWatchLabel extends JLabel implements MouseListener {
   ...
   public void mousePressed(MouseEvent evt) {
      if (running == false) {
         ...
         setText("Timing....");
         RefreshText action = new RefreshText(startTime);
   ...
   private class RefreshText implements ActionListener {
	   private long startTime;
	   RefreshText(long startTime){
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (running){long intermediateTime = System.currentTimeMillis();
		double currentTime = (intermediateTime - startTime)/1000.0;
		setText("Elapsed time: " + currentTime + " sec.");}
	}  
